...
dateModified: 2026-01-06T02:29:27+00:00
---
(Does not apply to [[In Italian, in an imperative form, direct object pronouns are attached to the end of the conjugated verb|the imperative form]])
...
Indeed, this is [[When the form is non imperative, Direct object pronouns in Italian MUST be in front of the conjugated verb that points its action to them, if there is no 'to {verb}' verb form that points to them and to which it can be attached|required if there is not a 'to {verb}' form to attach the direct object pronoun]].
