...
This is [[When the form is non imperative, Direct object pronouns in Italian MUST be in front of the conjugated verb that points its action to them, if there is no 'to {verb}' verb form that points to them and to which it can be attached|necessary if no 'to {verb}' verb form exists]]
