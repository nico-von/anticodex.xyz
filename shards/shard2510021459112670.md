...
---
If a vowel follows [[The different meanings of the Italian words 'lo' and 'la'|'la']], it [[In Italian, some words that are used in succession with certain words can be contracted together to form a single word|contracts]] with the word it follows, and the 'a' in 'la' is replaced by an apostrophe
