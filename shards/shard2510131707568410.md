...
Using 'To have' does not apply for verbs of motion. [['essere' is used to create the past tense of Italian verbs of motion instead of 'to have'|Such verbs use 'to be' instead]] and have [[In Italian, the ending of past participles used with 'To be' are changed according to the gender(or number) of the doer|their endings also changed according to gender]]. However, [[In choosing between 'to have' or 'to be' in making the past tense in Italian, the action must directly be about motion, the doer moves|the action must directly be about motion where the doer actually goes from a place to another]].
