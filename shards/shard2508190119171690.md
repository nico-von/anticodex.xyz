...
14. [[In Italian, the verb ending for indicating that the doer is the third person plural in Italian '-ono' and '-ano' is not usually stressed]]
...
3. [['Mio' is made plural as 'miei' instead of 'mii', so as to separate the two consecutive 'i's that would otherwise be awkward to pronounce]]